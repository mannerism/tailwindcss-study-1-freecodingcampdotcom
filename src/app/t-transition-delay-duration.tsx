export default function Home() {
  return (
    <div className="Parent h-screen p-4">
      <div className="shadow-50 inline-block rounded-lg border bg-white p-4 text-black">
        <img
        ...
        <button className="cursor-pointer rounded-lg bg-cyan-500 px-3 py-2 text-white shadow shadow-cyan-500/50 transition delay-1000 duration-1000 hover:-translate-y-2">
          Say Hello
        </button>
      </div>
    </div>
